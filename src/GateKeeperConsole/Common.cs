...
namespace GatekeeperConsole
{
    ...
    public static class Common
    {
        ...
        private static readonly JsonSerializerOptions _SerializerOptionsPretty = new JsonSerializerOptions
        {
            WriteIndented = true,
        ...
        private static readonly JsonSerializerOptions _SerializerOptionsCompact = new JsonSerializerOptions
        {
            WriteIndented = false,
            DefaultIgnoreCondition = JsonIgnoreCondition.WhenWritingNull,
            Converters = { new JsonStringEnumConverter() }
        ...
        public static string SerializeJson(object obj, bool pretty)
        {
            ...
            if (pretty)
            {
                return JsonSerializer.Serialize(obj, obj.GetType(), _SerializerOptionsPretty);
            }
            else
            {
                return JsonSerializer.Serialize(obj, obj.GetType(), _SerializerOptionsCompact);
            }
        }
        ...
        public static T DeserializeJson<T>(string json)
        {
            ...
            return JsonSerializer.Deserialize<T>(json, _SerializerOptionsCompact);
        }
